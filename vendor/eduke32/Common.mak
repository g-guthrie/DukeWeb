...
ifeq ($(PLATFORM),EMSCRIPTEN)
    CXXONLYFLAGS := $(filter-out -fno-exceptions,$(CXXONLYFLAGS)) -fexceptions
endif
...
ifeq ($(RENDERTYPE),SDL)
    ...
    ifeq ($(PLATFORM),EMSCRIPTEN)
        ...
        LINKERFLAGS += -sUSE_SDL=2 -sALLOW_MEMORY_GROWTH -sWASM=1 -sNO_EXIT_RUNTIME=1 -sFORCE_FILESYSTEM=1 -sDISABLE_EXCEPTION_THROWING=0 -sASYNCIFY
    else ifneq ($(strip $(SDLCONFIG)),)
